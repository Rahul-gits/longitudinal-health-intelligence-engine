...
import { ClusterType, ClusterNode } from '../types/health';
import { 
  Activity, 
  History, 
  FileText, 
  ...
  return (
    <div className="flex flex-col h-full bg-[#FFFFFF] border-3 border-black shadow-[5px_5px_0px_0px_#000] overflow-hidden">
      ...
      <div className="px-4 py-3 border-b-3 border-black bg-[#00F5D4] flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center space-x-2">
          ...
          <div>
            ...
            <p className="text-[10px] font-mono font-bold text-black/90">7 Connected Data Clusters Telemetry</p>
          </div>
        </div>
      ...
      <div className="relative flex-1 bg-[#FAF8F5] overflow-hidden min-h-[360px] border-b-3 border-black">
        ...
        <div className="absolute bottom-2 left-2 right-2 px-3 py-2 bg-[#FFFFFF] border-2 border-black shadow-[3px_3px_0px_0px_#000] flex items-center justify-between text-[11px] font-mono font-bold text-black">
          <div className="flex items-center space-x-3">
            <span className="font-black font-display">STATUS SYNC:</span>
            <div className="flex items-center space-x-3">
              <span className="flex items-center gap-1"><span className="w-2.5 h-2.5 bg-[#FF70A6] border border-black"></span> Cited Cluster</span>
              <span className="flex items-center gap-1"><span className="w-2.5 h-2.5 bg-[#FF5722] border border-black"></span> Critical</span>
              <span className="flex items-center gap-1"><span className="w-2.5 h-2.5 bg-[#CCFF00] border border-black"></span> Normal Baseline</span>
            </div>
          </div>
          <span className="hidden md:inline text-[10px] font-black uppercase bg-[#FFE600] px-1 border border-black">CLICK NODE TO INSPECT</span>
        </div>
      </div>
      ...
      {selectedNode && (
        <div className="p-4 bg-[#FFFFFF] flex flex-wrap items-center justify-between gap-3 text-xs">
          ...
          <div className="flex items-center space-x-4">
            <div className="bg-[#FAF8F5] p-2 border border-black">
              <span className="text-black/70 text-[9px] font-black uppercase block">VALUE</span>
              <span className="font-black text-black font-mono">{selectedNode.value}</span>
            </div>
            <div className="bg-[#CCFF00] p-2 border border-black">
              <span className="text-black text-[9px] font-black uppercase block">PROVENANCE</span>
              <span className="font-black text-black font-mono">EHR Verified (98%)</span>
            </div>
          </div>
        </div>
      )}
